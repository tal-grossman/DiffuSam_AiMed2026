...
\vspace{0.08cm}
\begin{center}
\includegraphics[width=0.94\columnwidth]{pipeline_a_cropped.png}
\end{center}
\vspace{1pt}
...
\vspace{0.04cm}
\begin{center}
\includegraphics[width=0.76\columnwidth]{pipeline_b_cropped.png}
\end{center}
\vspace{1pt}
...
\begin{center}
\includegraphics[width=0.92\columnwidth]{inference_steps_patient_36_slice_32.png}\\[4pt]
\includegraphics[width=0.92\columnwidth]{inference_steps_patient_IMG-0007-2_slice_10.png}
\end{center}
\vspace{2pt}
...
\begin{enumerate}[leftmargin=1.15em, itemsep=2pt, topsep=1pt]
...
\end{minipage}\hfill
\begin{minipage}[t]{0.48\columnwidth}
\begin{enumerate}[leftmargin=1.15em, itemsep=2pt, topsep=1pt, start=6]
